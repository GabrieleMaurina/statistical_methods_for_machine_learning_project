...
def main():
    ...
    for input_size in input_sizes:
        ...
        #for 30 models
        for model,depth,size,type in models(input_size,n_labels):
            history_file = join(output_folder,f'{input_size}_{type}_{depth}_{size}.json')

            #if it wasn't already computed
